...
class ServerPort(models.Model):
    ...
    SID = models.ForeignKey('ServerS',verbose_name="Server",null=True,on_delete=models.SET_NULL)
    PID = models.ForeignKey('Port',verbose_name="端口",null=True,on_delete=models.SET_NULL)
